...
public class AlchemyRecipes
{
	...
	public static void registerMinestuckRecipes()
	{
		...
		GristRegistry.addGristConversion(new ItemStack(claymore), false, new GristSet(new GristType[] {GristType.Build, GristType.Rust}, new int[] {200, 25}));
		...
		CombinationRegistry.addCombination(new ItemStack(Items.IRON_SWORD), new ItemStack(Items.IRON_INGOT), MODE_AND, false, true, new ItemStack(claymore));
